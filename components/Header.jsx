  ...
  return (
    <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4 z-10 relative'>
        ...
        <div className='flex flex-col sm:flex-row items-center gap-4 mt-2'>
            ...
            className='px-10 py-3 border rounded-full border-gray-500 flex items-center hover:bg-btnHover transition-all ease-in gap-2 bg-white dark: text-black'>My Resume <a href="/ATS_Resume_FaisalNawaz.pdf" download title="Download Resume"><Image src={assets.download_icon} className='w-4' alt='' /></a>  <a href="/ATS_Resume_FaisalNawaz.pdf" target="_blank" title="View Resume"><Image src={assets.view_icon} className='w-4' alt='' /></a></motion.div>
