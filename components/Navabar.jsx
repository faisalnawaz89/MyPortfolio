...
const Navabar = ({isDarkMode, setIsDarkMode}) => {
  ...
  return (
    <>
        ...
        <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-between justify-between z-50 ${isScroll ? "bg-white bg-opacity-50 backdrop-blur-lg shadow-sm dark:bg-darkTheme shadow-white/20":""}`}>
            <a className="flex-1" href="#top">
                <Image src={isDarkMode ? assets.logo_dark:assets.logo} className='w-20 sm:w-40 cursor-pointer mr-14' alt='' />
            </a>
            ...
            <div className='flex flex-1 items-stretch justify-end gap-4'>
